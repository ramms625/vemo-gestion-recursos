...
namespace Vemo.Gestion.Recursos.Data.Migrations
{
    /// <inheritdoc />
    public partial class Migracioninicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RecursosCompartidos",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CapacidadTotal = table.Column<int>(type: "int", nullable: false),
                    CapacidadDisponible = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecursosCompartidos", x => x.Id);
                });
